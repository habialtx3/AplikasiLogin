...
public class DatabaseHelper2 extends SQLiteOpenHelper {
        ...
        public Note getNote(long id){
            ...
            Cursor cursor = db.query(TABLE_NAME, new String[]{COLUMN_ID,COLUMN_TITLE,COLUMN_CONTENT,COLUMN_DATE},
        ...
        public  List<Note> searchNote(String keyword){
            List<Note> notes = new ArrayList<>();
            String searchQuery = "SELECT * FROM " + TABLE_NAME + " WHERE " + COLUMN_TITLE + " LIKE ? OR " + COLUMN_TITLE + " LIKE ? ORDER BY " + COLUMN_DATE + " DESC ";
            SQLiteDatabase db = this.getReadableDatabase();
